...
export class Search extends Component {
    ...
    componentDidMount(){
        ...
        axios.get(`https://api.themoviedb.org/3/search/movie?api_key=5db881d3ea32d395b4eaddb1cd022090&language=en-US&query=${query}&page=${page}&include_adult=true`)
            .then(res => {
                page = page + 1;
    ...
    handleSubmit(event){
        ...
        if(this.state.query != ""){
            ...
            page = 1;
            axios.get(`https://api.themoviedb.org/3/search/movie?api_key=5db881d3ea32d395b4eaddb1cd022090&language=en-US&query=${this.state.query}&page=${page}&include_adult=true`)
                .then(res => {
                    page = page + 1;
                    return this.setState({
                        movieList : res["data"]["results"],
